...
<div class='row maincontent'>
	<header>
		Orientation week Management
	</header>
	
	<div class="col-sm-12 col-md-12">
		<div class=''>
		<ul class="nav nav-tabs">
		  <li class='active'><a href="#statistictab" data-toggle="tab">Statistics</a></li>
		  <li><a href="#addstudenttab" data-toggle="tab">Add student</a></li>
		  <li><a href="#registrationtab" data-toggle="tab">Registration</a></li>
		</ul>
		</div>
	</div>
	...
	<div class="tab-content">
		<div class="tab-pane fade in active" id="statistictab"> 
			...
			<div class="col-sm-12 col-md-6 chartcontainer">
				<section>
					<h2>By Gender</h2>
					<div>
