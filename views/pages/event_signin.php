...
<div class='row text-center'>
  <h1><b>Sign in - <?php echo $this->event['name']?></b><br></h1>
<div class='col-md-5'>
  <form role="form" action='<?php echo URL?>merit/attendance'>
    <fieldset>
	  ...
	  <input type='submit' class="btn btn-primary btn-md" role="button" value='Sign in event'/>
    </fieldset>
	  <p>
	  <div id="loading" style='display:none'>&nbsp;</div>
	  <div class="alert alert-success col-md-offset-1 col-md-10">
		<span class="alert-link"></span> - Signed in successfully!
	  </div>
	  <div class="alert alert-danger col-md-offset-1 col-md-10">
		<span class="alert-link"></span> - Failed to sign in: <span id='failmsg'></span>
	  </div>
	  </p>
  </form>
</div>
